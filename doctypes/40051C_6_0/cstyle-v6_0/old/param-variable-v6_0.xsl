...
<xsl:param name="footnote.number.symbols" select="''"/>
	...
	<xsl:param name="docsecr">
		<xsl:choose>
			<xsl:when test="//paper.manual/@security='ts'">
				<xsl:text>TOP SECRET</xsl:text>
			</xsl:when>
			<xsl:when test="//paper.manual/@security='s'">
				<xsl:choose>
			...
			<xsl:when test="//paper.manual/@security='c'">
				<xsl:choose>
					<xsl:when test="descendant::*[@security='ts']">
						<xsl:text>TOP SECRET</xsl:text>
					</xsl:when>
			...
			<xsl:when test="//paper.manual/@security='fouo'">
				<xsl:choose>
					<xsl:when test="descendant::*[@security='ts']">
						<xsl:text>TOP SECRET</xsl:text>
					</xsl:when>
			...
			<xsl:when test="//paper.manual/@security='uc' or //paper.manual/@security=''">
				<xsl:choose>
					<xsl:when test="descendant::*[@security='ts']">
						<xsl:text>TOP SECRET</xsl:text>
					</xsl:when>
	...
	<xsl:param name="revno" select="//paper.manual/@revno | //destruction_manual/@revno | //ammo/@revno | //sys-ts/@revno"/>
	...
	<xsl:param name="typelvltitle">
		<xsl:choose>
			...
			<xsl:when test="contains(//paper.manual/@maintlvls, 'avum-avim')">
				<xsl:text>AVIATION UNIT AND INTERMEDIATE MAINTENANCE MANUAL</xsl:text>
			</xsl:when>
