   ...
   <fo:table-column column-width="proportional-column-width(2)"/>
	...
	<xsl:template match="chgsheet/prtitle">
		<fo:wrapper font-family="sans-serif" font-size="12pt" margin="20pt" font-weight="bold" text-transform="uppercase">
			...
			<xsl:if test="//paper.manual/@maintlvls='dmwr'">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"></fo:block>
				<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"></fo:block>
			</xsl:if>
	<xsl:if test="//paper.manual/@maintlvls='nmwr'">
				...
				<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center">NATIONAL MAINTENANCE OVERHAUL STANDARDS</fo:block>
			</xsl:if>			
			
			<fo:block space-after.maximum="12pt" space-after.minimum="10pt" space-after.optimum="10pt" space-before.maximum="4pt" space-before.minimum="0pt" space-before.optimum="4pt" span="all" text-align="center">FOR</fo:block>
	...
	<xsl:template match="chgpagelist">
		...
		<xsl:when test="string-length(title[1])=0">
			<!--<fo:block start-indent="6pc">-->
					<fo:list-block provisional-distance-between-starts="12pc" provisional-label-separation="1pc" tart-indent="6pc">
