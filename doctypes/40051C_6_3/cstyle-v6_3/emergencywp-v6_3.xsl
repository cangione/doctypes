...
<xsl:variable name="resource-location-url" select="resolve-uri('emergencywp-v6_3.xsl')" /><!-- is the xsl file base directory -->
<xsl:variable name="resource">
	<xsl:value-of select="replace($resource-location-url,'file:/.:','')"/>
</xsl:variable>
<xsl:variable name="slash2">
	<xsl:value-of select="concat(replace($resource,'/emergencywp-v6_3.xsl',''), '//slash2.gif')"/>
</xsl:variable>
<xsl:variable name="slashrt">
	<xsl:value-of select="concat(replace($resource,'/emergencywp-v6_3.xsl',''), '//slashrt.gif')"/>
</xsl:variable>
