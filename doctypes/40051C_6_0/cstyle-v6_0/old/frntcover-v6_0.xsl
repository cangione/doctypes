...
-->	
	...
	<fo:block-container>
		<fo:block font-size="8pt" font-weight="bold" space-after="12pt" space-before.maximum="8pt" space-before.minimum="6pt" space-before.optimum="7pt" span="all" text-align="right" text-transform="uppercase">
			<xsl:value-of select="date"/>
...
-->
	...
	<xsl:template match="tmtitle/prtitle">
		...
		<xsl:if test="//sum">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">SOFTWARE USERS MANUAL</fo:block>
			</xsl:if>	
			<xsl:if test="//sam">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">SOFTWARE ADMINISTRATORS MANUAL</fo:block>
			</xsl:if>	
			<xsl:if test="//paper.manual/@maintlvls!='dmwr'">
				<xsl:if test="//paper.manual/@maintlvls!='nmwr'">
			...
			<xsl:if test="//dmwr_ammo">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">DEPOT MAINTENANCE WORK REQUIREMENT</fo:block>
			</xsl:if>
			<xsl:if test="//pmc">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">PREVENTIVE MAINTENANCE CHECKLIST</fo:block>
			</xsl:if>
					<xsl:if test="//pms">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">PREVENTIVE MAINTENANCE SCHEDULE</fo:block>
			</xsl:if>
		<xsl:if test="//pmi">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">PHASED MAINTENANCE INSPECTION</fo:block>
			</xsl:if>
		<xsl:if test="//sys-ts">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">SYSTEM-WIDE TROUBLESHOOTING AVIATION – TECHNICAL MANUAL</fo:block>
			</xsl:if>	
		 <xsl:choose>			
			<xsl:when test="//lubeorder">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center" font-family="sans-serif" font-size="24pt" font-weight="bold" text-transform="uppercase">LUBRICATION ORDER</fo:block>
			</xsl:when>
			<xsl:when test="//bdar"> <!-- title and maintlvl($typelvltitle) the same -->
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">BATTLE DAMAGE ASSESSMENT AND REPAIR (BDAR)</fo:block>
			...
			<xsl:when test="//destruction_manual"> <!-- title and maintlvl($typelvltitle) the same -->
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="26pt" space-before.minimum="20pt" space-before.optimum="24pt" span="all" text-align="center">DESTRUCTION OF EQUIPMENT TO PREVENT ENEMY USE</fo:block>
				<fo:block space-after.maximum="12pt" space-after.minimum="10pt" space-after.optimum="10pt" space-before.maximum="4pt" space-before.minimum="0pt" space-before.optimum="4pt" span="all" text-align="center">
					<xsl:text>FOR</xsl:text>
				</fo:block>
			</xsl:when>						
			<xsl:otherwise> <!-- all other cases get typelvltitle-->
				...
				<xsl:if test="//paper.manual/@maintlvls='dmwr'">
					<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"/>
					<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"/>
				</xsl:if>
				<xsl:if test="//paper.manual/@maintlvls='nmwr'">
