	...
	<fo:flow flow-name="xsl-region-body">
			<fo:block space-before.conditionality="discard" space-before.maximum="8pt" space-before.minimum="6pt" space-before.optimum="7pt" span="all">
			 ...
			 <fo:block text-align="justify"><fo:leader xsl:use-attribute-sets="header-leader-attrs"/>
					...
					<fo:block font-size="12pt" font-weight="bold" space-after="2pt" space-before="12pt" span="all" text-align="right" text-transform="uppercase">
						<xsl:apply-templates select="servnomen"/><xsl:text disable-output-escaping="no">&#x2002;</xsl:text></fo:block>
					<fo:block font-size="12pt" font-weight="bold" space-after="36pt" space-before="2pt" span="all" text-align="right" text-transform="uppercase">
							<xsl:choose> 
...
<!--					<fo:block text-align="justify">
					...
					<fo:block>
						<xsl:apply-templates select="prtitle | stitle | weapon-system | reporting | pm.warning.data"/>&#x2002;</fo:block>
					<fo:block>&#x2002;</fo:block>
					<fo:block>&#x2002;</fo:block>
					<fo:block>&#x2002;</fo:block>
					<fo:block>&#x2002;</fo:block>
	...
	<xsl:template match="titleblk/prtitle">
		...
		<xsl:if test="//sum">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center">SOFTWARE USERS MANUAL</fo:block>
			...
			<xsl:if test="//sam">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center">SOFTWARE ADMINISTRATORS MANUAL</fo:block>
				<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"/>
			</xsl:if>	
		<xsl:if test="//dmwr_ammo">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center">DEPOT MAINTENANCE WORK REQUIREMENT</fo:block>
				<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"/>
			</xsl:if>	
			<xsl:if test="//ammo">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center">AMMUNITION</fo:block>
				<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"/>
			</xsl:if>
			...
			<!-- typelvltitle and maintlvls the same text, no need to duplicate -->
			<!--xsl:if test="//paper.manual/@maintlvls='dmwr'">
				<fo:block space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center">DEPOT MAINTENANCE WORK REQUIREMENT</fo:block>
				<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center"/>
			</xsl:if>
			<xsl:if test="//paper.manual/@maintlvls='nmwr'">
				...
				<fo:block font-weight="bold" space-after.maximum="6pt" space-after.minimum="2pt" space-after.optimum="2pt" space-before.maximum="2pt" space-before.minimum="2pt" space-before.optimum="2pt" span="all" text-align="center">NATIONAL MAINTENANCE
					OVERHAUL STANDARDS</fo:block>
			</xsl:if-->
			<fo:block space-after.maximum="6pt" space-after.minimum="4pt" space-after.optimum="4pt" space-before.maximum="4pt" space-before.minimum="0pt" space-before.optimum="4pt" span="all" text-align="center">FOR</fo:block>
